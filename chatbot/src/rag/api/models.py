...
class ChatRequest(BaseModel):
    ...
    selected_text: Optional[str] = Field(default=None, description="Selected text from the book to base answer on")
...
class ChatResponse(BaseModel):
    ...
    conversation_id: Optional[str] = Field(default=None, description="Conversation ID for follow-up (stateless)")
